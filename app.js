...
app.get('/', function (req, res) {
	var cursor = db.collection('adresse').find().toArray(function(err, resultat){
		...
		res.render('index.ejs', {adresse: resultat, acc:true})
	}) 
});
...
app.get('/profil/:id',(req, res) =>{
 ...
 console.log(id)
 db.collection('adresse').find({_id: ObjectID(req.params.id)}).toArray(function (err, resultat) {
console.log(resultat);
if (err) return console.log(err)
  res.render('index.ejs', {adresse: resultat, profil:true}) // redirige vers la route qui affiche la collection
 })
...
app.get('/trier/:cle/:ordre', (req, res) => {
	...
	let cursor = db.collection('adresse').find().sort(cle,ordre).toArray(function(err, resultat) {
		...
		res.render('components/adresses.ejs', {adresse: resultat, cle, ordre})
	})
});
